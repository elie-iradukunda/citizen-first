...
// MAIL_PROVIDER is not set explicitly. The HTTP API providers (Brevo, Resend)
// come first because Railway blocks every outbound SMTP port, 2525 included,
// so the `smtp` provider only ever works from a machine that allows it.
